...
public class DeleteProcessDefinitionCommandHandlerTest {

    @InjectMocks
    private DeleteProcessDefinitionCommandHandler deleteProcessDefinitionCommandHandler;
    ...
    void testHandle() {
        ...
        //
        // When
        // ResponseEntity<Map<String, ?>> response = deleteProcessDefinitionCommandHandler.handle(command);
        //
        // Then
